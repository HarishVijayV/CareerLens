...
| What | Result |
|---|---|
| Rows processed | 205,397 → **5,397** after dedup (4,041 duplicates removed) |
| Of which real | **5,397** live postings from Adzuna (India + USA); the rest generated for volume |
